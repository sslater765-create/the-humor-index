      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <div className="space-y-4 text-sm text-brand-text-secondary leading-relaxed">
            ...
            <p>
              It started as my first project like this. Turns out quantifying humor is
        ...
        <section>
          ...
          <div className="space-y-4 text-sm text-brand-text-secondary leading-relaxed">
            <p>
              We&apos;ve fully analyzed The Office, Seinfeld, Friends, Parks and Rec, and
              Schitt&apos;s Creek. Next up: Arrested Development, 30 Rock, Brooklyn Nine-Nine,
            ...
            <p>
              ...
              and get show suggestions based on what you actually find funny. Think Letterboxd,
              but for sitcoms.
            </p>
            <p>
              Beyond that? More shows based on{' '}
        ...
        <section className="border-t border-brand-border pt-8">
          ...
          <p className="text-xs text-brand-text-muted mt-8">
            The Humor Index is a project of Humor Index Media LLC, Florida.
          </p>
        </section>
