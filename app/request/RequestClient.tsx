    ...
    <div className="space-y-8">
      ...
      <div className="bg-brand-card border border-brand-border rounded-xl p-4">
        ...
        <div className="space-y-2 mb-3">
          {['The Office', 'Seinfeld', 'Friends', 'Parks and Recreation', "Schitt's Creek", 'Arrested Development', '30 Rock', 'Taxi', 'Community', 'The Simpsons', 'Veep', "It's Always Sunny in Philadelphia"].map(name => (
        ...
        <div className="flex flex-wrap gap-2">
          {['Brooklyn Nine-Nine', 'All in the Family', 'M*A*S*H', 'The Jeffersons',
