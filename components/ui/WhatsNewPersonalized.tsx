...
const ALL_ITEMS: NewItem[] = [
  { href: '/blog/display-scale-recalibration', label: 'Latest Blog', labelColor: 'text-brand-gold', title: "We Just Recalibrated the Display Scale. Here's What Changed.", subtitle: 'May 15, 2026', date: '2026-05-15' },
