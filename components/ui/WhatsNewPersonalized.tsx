...
const ALL_ITEMS: NewItem[] = [
  { href: '/blog/30-rock-takes-the-crown', label: 'Latest Blog', labelColor: 'text-brand-gold', title: "30 Rock Just Took #1. By the Biggest Gap We've Measured.", subtitle: 'May 14, 2026', date: '2026-05-14' },
